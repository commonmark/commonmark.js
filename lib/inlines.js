...
var processEmphasis = function(stack_bottom) {
    ...
    var tmp, next;
    var opener_found;
    var potential_openers = [];

    potential_openers[C_UNDERSCORE] = stack_bottom;
    potential_openers[C_ASTERISK] = stack_bottom;
    potential_openers[C_SINGLEQUOTE] = stack_bottom;
    potential_openers[C_DOUBLEQUOTE] = stack_bottom;
    ...
    while (closer !== null) {
        ...
        if (!(closer.can_close && (closercc === C_UNDERSCORE ||
            ...
            opener_found = false;
            while (opener !== null && opener !== potential_openers[closercc]) {
            ...
            if (!opener_found) {
                ...
                potential_openers[closercc] = closer;
