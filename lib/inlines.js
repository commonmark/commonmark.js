...
// Returns the character at the current subject position, or ''
...
var parseEmphasis = function(c, block) {
...
var processEmphasis = function(block, stack_bottom) {
    ...
    while (closer !== null) {
        if (closer.can_close && (closer.c === '_' || closer.c === '*')) {
            // found emphasis closer. now look back for first matching opener:
            opener = closer.previous;
            while (opener !== null && opener !== stack_bottom) {
                if (opener.c === closer.c && opener.can_open) {
                    break;
                }
